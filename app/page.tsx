...
export default function Home() {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center px-4 relative overflow-hidden bg-gradient-to-b from-imperial-black to-imperial-darkGray">
      {/* Background Effects */}
      ...
      <div className="relative z-10 text-center max-w-4xl">
        ...
        <motion.div
          ...
          transition={{ duration: 0.8 }}
        >
          <h1 className="text-7xl md:text-9xl font-serif mb-4 tracking-tight bg-gradient-to-r from-imperial-gold to-imperial-lightGold bg-clip-text text-transparent">
            IMPERIUM AI
          </h1>
          <div className="h-1 w-64 mx-auto bg-gradient-to-r from-imperial-gold to-imperial-lightGold mb-8"></div>
        </motion.div>
        ...
        >
          <button
            onClick={() => router.push('/auth/signup')}
            className="px-8 py-4 bg-gradient-to-r from-imperial-gold to-imperial-lightGold text-imperial-black font-semibold rounded-lg hover:shadow-gold-lg hover:scale-105 transition-all duration-300 text-xl"
          >
            Begin Your Ascent
          </button>
          ...
          <button
            onClick={() => router.push('/auth/login')}
            className="px-8 py-4 text-imperial-gold border-2 border-imperial-gold font-semibold rounded-lg hover:bg-imperial-gold hover:text-imperial-black transition-all duration-300 text-xl"
          >
            Return to Power
          </button>
        </motion.div>
